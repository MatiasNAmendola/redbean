...
class Facade
{
	...
	public static function graph($array, $filterEmpty=false) { $c = new \RedBean\Plugin\Cooker(); $c->setToolbox(self::$toolbox);return $c->graph($array, $filterEmpty);}
	public static function syncSchema($from, $to) { return \RedBean\Plugin\Sync::syncSchema($from, $to); }
	public static function log($filename) { $tl = new \RedBean\Plugin\TimeLine($filename); self::$adapter->addEventListener('sql_exec', $tl);}
	 ...
	 *
	 * @param  OODBBean|SimpleModel $bean bean
	 *
	 * @return mixed
	 */
	 ...
	 *
	 * @param OODBBean|SimpleModel $bean bean to be deleted
	 *
	 * @return void
	 */
	...
	{
		return Facade::$redbean->count( $beanType, $addSQL, $bindings );
	}
